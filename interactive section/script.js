...
var plus = document.querySelectorAll(".fa");
var ext = document.querySelector(".twelve");

var count = 0;
plus.forEach(function(gt){
    gt.addEventListener("click", function(){
     if(gt.classList.contains("fa-plus")){
         count++;
        
     }else if(gt.classList.contains("fa-minus")){
         count--;
     }else{
         count = 0;
     }
     ext.textContent = count;
